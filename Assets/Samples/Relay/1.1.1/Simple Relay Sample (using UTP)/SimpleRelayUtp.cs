...
public class SimpleRelayUtp : MonoBehaviour
{
    ...
    public void OnBindHost()
    {
        ...
        var networkInterface = new WebSocketNetworkInterface();

        // Create the Host's NetworkDriver from the NetworkSettings.
        hostDriver = NetworkDriver.Create(networkInterface, settings);
    ...
    public void OnBindPlayer()
    {
        ...
        playerDriver = NetworkDriver.Create(networkInterface, settings);
